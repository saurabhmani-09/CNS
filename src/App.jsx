...
const tld = '.chess';
const CONTRACT_ADDRESS = '0x3c9397c7171D9be0475842CA08aF5E37B1Ad71F7';
  ...
  setLoading(false);
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/RJtdD0BtR9aOVMaxOl/giphy-downsized-large.gif" alt="Ninja donut gif" />
...
const editRecord = (name) => {
  ...
  if (network !== 'Polygon Mumbai Testnet') {
    ...
    <div className="form-container">
      ...
      <input
        type="text"
        value={record}
        placeholder='whats ur chess power?'
  ...
  <header>
    <div className="left">
      <p className="title">🐱‍👤 Chess Name Service</p>
